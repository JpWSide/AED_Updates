...
int *rodando;
void **pBuffer;
void *newNode(char *nome, int *idade, long *telefone);
void addContato(char *nome, int *idade, long *telefone, void **head);
...
void *newNode(char *nome, int *idade, long *telefone)
{
    void *nodo = (void *)calloc(1, sizeof(char) * 11 + sizeof(int) + sizeof(long) + sizeof(void **) * 2);

    char *pNome = (char *)nodo;
    int *pIdade = (int *)(nodo + sizeof(char) * 11);
    long *pNumero = (long *)(nodo + sizeof(char) * 11 + sizeof(int));
    void **pAnt = (void **)(nodo + sizeof(char) * 11 + sizeof(int) + sizeof(long));
    void **pProx = (void **)(nodo + sizeof(char) * 11 + sizeof(int) + sizeof(long) + sizeof(void **));
...
void addContato(char *nome, int *idade, long *telefone, void **head)
{
    ...
    *atual = (void *)*head;
    ...
    {
        *pProx = *atual;
        void **antDeAtual = (void **)(nodo + sizeof(char) * 11 + sizeof(int) + sizeof(long));
        *antDeAtual = nodo;
        *head = nodo;
    }
    else if (*atual != NULL)
    {
        void **antDeProx = (*ant + sizeof(char) * 11 + sizeof(int) + sizeof(long) + sizeof(void **));
        *antDeProx = nodo;
        *pProx = *atual;
        void **antDeAtual = (void **)(*atual + sizeof(char) * 11 + sizeof(int) + sizeof(long));
        *antDeAtual = nodo;
        *pAnt = ant;
    }
    else
...
void delContato(char *nome, void **head)
{
    ...
    *atual = (void *)*head;
    ...
    void **pAnt = (void **)(*atual + sizeof(char) * 11 + sizeof(int) + sizeof(long));
    void **pProximo = (void **)(*atual + sizeof(char) * 11 + sizeof(int) + sizeof(long) + sizeof(void **));

    if (*pProximo != NULL)
    {
        void **antDoProximo = (void **)(*ant + sizeof(char) * 11 + sizeof(int) + sizeof(long) + sizeof(void **));
        *antDoProximo = *pProximo;
        void **proximoDoAnt = (void **)(*pProximo + sizeof(char) * 11 + sizeof(int) + sizeof(long) + sizeof(void **));
        *proximoDoAnt = *ant;
    }
    else if (*pAnt != NULL)
    {
...
void menu()
{
    ...
    case 1:
        ...
        long *telefone = malloc(sizeof(long));
